...
Đo lúc **22:51 ngày 30/08/2026** (giờ Việt Nam).

```
## 1. Máy đang chạy đứng ở đâu

  Địa chỉ IP: 20.168.128.242
...
## 3. Các trang kết quả xổ số khác
  ...
  ✓ kqxs.vn               HTTP 200          265584 byte  2.0s   ngày mới nhất 30/08/2026  (CÓ hôm nay)
  ✓ minhngoc              HTTP 200          198508 byte  1.8s   ngày mới nhất 30/08/2026  (CÓ hôm nay)
  ✗ xosodaiphat           HTTP 404           38517 byte  0.5s
  ✗ xoso.me               HTTP 404           40302 byte  0.7s
  ✓ ketqua1               HTTP 200            6989 byte  0.8s   không thấy ngày nào
...
## 4. Kho dữ liệu sẵn trên GitHub (đường dự phòng)
  ...
  ✓ googlesky/power645    HTTP 200          161350 byte  0.1s   kỳ cuối 01555 ngày 2026-08-28  (1358 kỳ)
