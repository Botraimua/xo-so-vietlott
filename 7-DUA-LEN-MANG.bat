...
chcp 65001 >nul
pushd "%~dp0"
title Dua bao cao len mang - Vietlott cua chi
...
echo.
echo   [3/4] Dung ban cong khai (KHONG kem ve cua chi)...
...
echo   Chi chay 8-DANG-NHAP-VERCEL.bat mot lan, roi quay lai bam nut 7 nay.
echo.
